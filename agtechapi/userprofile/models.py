...
class UserProfile(models.Model):
	...
	parent_id		= models.CharField(max_length=20,blank=True,null=True,  help_text="Parent id associated with this account.")
	parent 			= models.ForeignKey(User, blank=True,null=True, related_name="account_parent", help_text="Account ID of the device_sn.")
